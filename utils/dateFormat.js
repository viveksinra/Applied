function formatDateForOne(date){
  if(date)
 { 
...
function convertTimeTo12HourFormat(time) {
  ...
  module.exports = {
    formatDateForOne, formatDateToMmDdYyyy,formatDateToLong,setTimeToZero,formatDateToShortMonth,formatDateToISO,convertTimeTo12HourFormat,convertTimeTo24HourFormat,formatTimeWithTimeZone
};