...
function TopNavTabs({navTabVal,setNavTabVal}) {
  return (
    <Box sx={{ typography: 'body1',display: { xs: 'none', sm: 'block'} }}>
    <TabContext value={navTabVal} >
      {/* <Box sx={{ borderColor: 'divider' }}> */}
        <TabList onChange={(e,v)=>setNavTabVal(v)} textColor="white" indicatorColor="secondary" aria-label="lab API tabs example">
